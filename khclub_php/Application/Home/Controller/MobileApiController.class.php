...
/////////////////////////////////////////////首页'圈子'部分////////////////////////////////////////////////////////////
     ...
     * 接口地址
     * http://localhost/jlxc_php/index.php/Home/MobileApi/likeOrCancel
     * @param isCircle 点赞还是取消 1是赞 0是取消
     * @param circle_id 圈子id
     * @param user_id 用户id
     * */
    public function followOrUnfollowCircle(){
        try{
            ...
            //状态
            $sql = 'SELECT pc.id, pc.user_id FROM kh_personal_circle pc, kh_user_circle uc WHERE pc.id='.$circle['circle_id'].' and pc.user_id='.$circle['user_id'];
            $myPersonalModel = M();
            ...
            if($oldCircle){
                ...
                if($oldCircle['delete_flag'] == !$isCircle){
                    returnJson(0,"关注过了");
                    $circleModel->rollback();
                    return;
                }

                $oldCircle['delete_flag'] = !$isCircle;
                //将关注状态数减一或者加以
                if($isCircle) {
